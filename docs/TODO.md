...
- [ ] 스킬 계산식 원본 정밀화
- [ ] 반응 스킬 실제 연결
- [ ] 특수 효과/상태 이상/광역 효과 원본 규칙 확인 후 구현

## 장비 관련 남은 TODO

- [ ] 장비 원본 목록/등급/가격 정밀화
- [ ] 장비 statBonus 원본 규칙 반영
- [ ] 착용 중 장비 판매/교체 UX 정리
...
- [x] 플레이어 1명/적 1명/고정 11x11 맵 구조 고정
...
- [x] 저장 구조 saveVersion 3 반영
- [x] 층 클리어/보상 선택 UI
- [x] 외모 기반 보상 후보 생성
- [x] 보상 선택 후 코인/인벤토리 반영
- [x] 저장 구조 saveVersion 4 반영
- [x] 5Lv 플러스 적용
- [x] 레벨업 UI
- [x] 레벨업 스탯 분배
- [x] 저장 구조 saveVersion 5 반영
- [x] 보상 아이템 사용 효과 일부
- [x] 마법서 습득 판정
- [x] 인벤토리 사용/판매 UI
- [x] 보유 마법 목록
- [x] 저장 구조 saveVersion 6 반영
- [x] 마법 전투 시전 1차 구현
- [x] 마법 MP 소모/위력 계산
- [x] 보유 마법 행동 큐 추가 UI
- [x] 전투 중 아이템 행동 구조
